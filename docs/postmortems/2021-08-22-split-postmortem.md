...
- Place the fix into the PR optimizing the jumpdest analysis [233381](https://github.com/elastos/Elastos.ELA.SideChain.ESC/pull/23381).
...
```
We have identified a security issue with Elastos.ELA.SideChain.ESC, and will issue a
...
upgrade to the latest Elastos.ELA.SideChain.ESC codebase. More information about the
