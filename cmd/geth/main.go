...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the Elastos.ELA.SideChain.ESC command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2021 The Elastos.ELA.SideChain.ESC Authors"
