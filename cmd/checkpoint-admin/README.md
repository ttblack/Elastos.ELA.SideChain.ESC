...
There are several hardcoded checkpoints in the [source code](https://github.com/elastos/Elastos.ELA.SideChain.ESC/blob/master/params/config.go#L38) of the Elastos.ELA.SideChain.ESC project. These checkpoints are updated by Elastos.ELA.SideChain.ESC developers when new versions of software are released. Because light client users trust Geth developers to some extent, hardcoded checkpoints in the code can also be considered correct.
...
```shell
go get github.com/elastos/Elastos.ELA.SideChain.ESC/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/elastos/Elastos.ELA.SideChain.ESC/blob/master/params/config.go#L251).*
